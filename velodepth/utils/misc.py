...
def match_gt(
    tensor1, tensor2, padding1, padding2, mode: str = "bilinear", padding1_mode="input"
):
    """
    ...
    for i in range(batch_size):
        ...
        elif padding1_mode == "output":
            item1_unpadded = item1
            h2, w2 = (
                item2.shape[1] - pad2_t - pad2_b + pad1_t + pad1_b,
