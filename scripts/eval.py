...
import velodepth.datasets as datasets
from velodepth.datasets import DistributedSamplerNoDuplicate, collate_fn
from velodepth.models import VeloDepth
from velodepth.utils import is_main_process, validate
from velodepth.utils.distributed import (create_local_process_group,
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Eval script", conflict_handler="resolve"
    )
    parser.add_argument("--master-port", type=str, default=29400)
    parser.add_argument("--distributed", action="store_true")
    parser.add_argument("--local_rank", type=int, default=0)
    parser.add_argument("--config-file", type=str, default="./configs/velodepth-eval.json")
    parser.add_argument("--camera-gt", action="store_true")
    parser.add_argument("--save-path", type=str, default="./velodepth.json")
